...
const Footer = () => {
	return (
		<>
			<div className='bg-gradient-to-t from-black to-[#121212] w-full mt-5 p-5'>
				{/* Social media icons*/}
				<div className='mx-auto container max-w-xl p-2'>
					...
					<div className='mt-4 w-[100%] mx-auto flex justify-center flex-wrap lg:space-y-3 space-y-2 text-white font-semibold text-sm lg:text-base space-x-2 lg:space-x-5'>
						<p className='cursor-pointer mt-3 text-blue-300'>
							Get the IMDb app{" "}
							<FaExternalLinkAlt className='inline ml-1 mb-1 text-xs' />
						</p>
						<p className='cursor-pointer hover:text-amber-200'>
							Help{" "}
							<FaExternalLinkAlt className='inline mb-1 text-xs lg:text-sm ml-1' />
						</p>
						<p className='cursor-pointer hover:text-amber-200'>
							Site Index{" "}
							<FaExternalLinkAlt className='inline mb-1 text-xs lg:text-sm ml-1' />
					...
					<div className='flex mx-auto justify-center mt-5'>
						<p className='text-xs font-semibold  text-slate-500 font-bold'>
							<FaRegCopyright className='inline text-xs' /> 1999 -{" "}
							{new Date().getFullYear()} by IMdb.com, Inc
						</p>
					</div>
				</div>
			</div>
